...
\end{itemize}
Die Entwicklung und Wartung des Softwareshops ist auch in dieser Kategorie das wichtigste. Um die vielen Nutzerversprechen zu erreichen, sind mehrere Aufgaben wichtig:
\begin{itemize}
